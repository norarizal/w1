...
```r
table4a # cetak dataset table4a tidak usah pakai library lagi
```
...
```r
glimpse(table4a) # contoh table4a ini kalau gak dirapiin pakai tidy
```
...
Cek apakah dataset 'tb8' sama dengan dataset 'tb_all'! Menurut Anda, cara penulisan *syntax* manakah yang lebih mudah digunakan dan dipahami? enak pake tb_all 
